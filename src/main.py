...
tags_metadata = [
    {
        "name": "films",
        "description": """Получение фильма по ID и список фильмов постранично,
        можно использовать поисковый запрос.""",
    },
    {
        "name": "genres",
        "description": """Получение жанра по ID и список жанров постранично,
        можно использовать поисковый запрос.""",
    },
    {
        "name": "persons",
        "description": """Получение персоны по ID и список участников постранично,
        можно использовать поисковый запрос.""",
    },
]
